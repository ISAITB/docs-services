...
.. code-block:: none
    ...
    mvn archetype:generate "-DarchetypeGroupId=eu.europa.ec.itb" "-DarchetypeArtifactId=template-test-service" "-DarchetypeVersion=1.27.1"
...
.. code-block:: none
    ...
    ...
    [INFO] ----------------------------------------------------------------------------
    [INFO] Using following parameters for creating project from Archetype: template-test-service:1.27.1
    [INFO] ----------------------------------------------------------------------------
